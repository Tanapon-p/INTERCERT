...
<head>
	...
	<title> Biznar - Business Agency HTML Template </title>
...
<body id="bdy">
			...
			<div class="container">
				<div class="page-not-wpr grid-2">
					<div class="page-not-left">
						<img src="<?= rootURL(); ?>assets/img/vector/404.webp" class="d-block text-center" alt="thumb">
					</div>
	...
	<!-- jQuery Frameworks
    ============================================= -->
	<script src="<?= rootURL(); ?>assets/js/jquery-3.6.0.min.js"></script>
