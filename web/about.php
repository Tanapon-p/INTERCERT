                    ...
                    <div class="col-xl-8">
                        <div class="service-single-wpr pr-50">
                            ...
                            <div class="service-tx mb-40">
                                ...
                                <ul class="mb-20 about-list">
                                    <li><i class="ti ti-angle-right"></i>การวางระบบ ISO ครอบคลุมทุกมาตรฐาน</li>
                                    <li><i class="ti ti-angle-right"></i>การอบรมเชิงปฏิบัติโดยผู้เชี่ยวชาญ</li>
                                    <li><i class="ti ti-angle-right"></i>การจัดทำเอกสารพร้อมให้คำปรึกษาเพื่อปรับปรุงระบบการทำงาน</li>
                                    <li><i class="ti ti-angle-right"></i>การซ้อมตรวจประเมินโดยอาจารย์ที่ปรึกษา</li>
                                    <li><i class="ti ti-angle-right"></i>ดูเเลทุกขั้นตอนกระบวนการทำงานจนถึงได้รับใบรับรองผล (Certificate)</li>
                                </ul>
                                <p class="mb-20">
